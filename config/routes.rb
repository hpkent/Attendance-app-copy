Rails.application.routes.draw do
 ...
 # calendars/google authenication
  ...
  delete '/students/:meeting_id/delete_meeting' => 'students#delete_meeting'
  ...
  get '/students/:student_id/new_meeting' => 'students#new_meeting'
  post '/students/update_meeting' => 'students#update_meeting'
